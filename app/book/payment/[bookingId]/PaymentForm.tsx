  ...
  return (
    <form id="payment-form" onSubmit={handleSubmit} className="w-full flex flex-col space-y-6">
      ...
      <Button 
        ...
        id="submit" 
        className="cursor-pointer w-full rounded-full bg-primary text-white hover:bg-primary-dark py-6 text-lg font-bold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5"
      >
        <span id="button-text">
          {isLoading ? (
